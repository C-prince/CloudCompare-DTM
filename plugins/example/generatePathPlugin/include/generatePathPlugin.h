...
**/
class generatePathPlugin : public QObject, public ccStdPluginInterface
{
	Q_OBJECT
	...
	Q_PLUGIN_METADATA( IID "cccorp.digitaltwinmanufacture.plugin.generatePath" FILE "../info.json" )

public:
	explicit generatePathPlugin( QObject *parent = nullptr );
	~generatePathPlugin() override = default;
