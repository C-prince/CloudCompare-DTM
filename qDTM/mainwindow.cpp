	...
	, m_pfDlg(nullptr)
{
	...
	ccConsole::Print(tr("DigitalTwinManufacture started!"));
}
...
void MainWindow::doActionResetGUIElementsPos()
{
	...
	QMessageBox::information( this,
							  tr("Restart"),
							  tr("To finish the process, you'll have to close and restart DigitalTwinManufacture") );
...
void MainWindow::doActionShowHelpDialog()
{
	...
	messageBox.setText("Please look at the <a href='http://www.digitaltwinmanufacture.org/doc/wiki'>wiki</a>");
