...
bool CommandCrossSection::process(ccCommandLineInterface &cmd)
{
	...
	static QString s_xmlDigitalTwinManufacture = "DigitalTwinManufacture";
	...
	QString outputFilePath;
	{
		...
		{
			return cmd.error(QString("Invalid XML file (should start by '<%1>')").arg(s_xmlDigitalTwinManufacture));
		}
